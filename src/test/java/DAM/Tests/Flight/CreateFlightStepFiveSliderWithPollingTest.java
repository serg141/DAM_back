...
public class CreateFlightStepFiveSliderWithPollingTest {
    ...
    public void getEndpoint() throws JSONException {
        ...
        body = new CreateFlightStepFiveSlider().getFlightHideableTypeWithPolling();
        placementId = new GetPlacementId().getPlacementId();
    }

    @Test
    public void successCreateFlightStepFiveSliderWithPolling() {
